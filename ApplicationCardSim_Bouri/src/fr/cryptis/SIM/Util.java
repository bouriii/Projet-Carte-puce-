...
public class Util {
	...
	public static String Services(Byte b) {
		...
		if((b & 0x80) == 0x80){
			service[0]=1;
			info+="\nLe service n 1 : permet la désactivation du code PIN d'utilisateur (CHV1) : est present";
		}
		else{
			service[0]=0;
			info+="\nLe service n 1 : permet la désactivation du code PIN d'utilisateur (CHV1) : n'est pas present";
